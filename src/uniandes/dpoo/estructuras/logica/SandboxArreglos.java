...
public class SandboxArreglos
{
    ...
    public void eliminarEntero( int valor )
    {
        ...
        int[] nuevo = new int[arregloEnteros.length - contador];
        int indice = 0;
    ...
    public void eliminarCadena( String cadena )
    {
        ...
        String[] nuevo = new String[arregloCadenas.length - contador];
        int indice = 0;
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        int[] copia1 = new int[arregloEnteros.length];
        int[] copia2 = new int[otroArreglo.length];

        for (int i = 0; i < arregloEnteros.length; i++)
        {
            copia1[i] = arregloEnteros[i];
        ...
        {
            for (int j = 0; j < copia1.length - 1 - i; j++)
            {
                if (copia1[j] > copia1[j + 1])
                {
                    int temp = copia1[j];
                    copia1[j] = copia1[j + 1];
                    copia1[j + 1] = temp;
